...
// __EinwilligungDesBetroffenen__ = OrdnerView
    ...
    render() {
        return (
            <div className="gebote">
                ...
                <TextComp>
                <strong>1. Eindeutig bestätigende Handlung</strong>
                ...
                <TextComp>
                <strong>Sonderregelung für Einwilligung von Kindern</strong>
...
export default __EinwilligungDesBetroffenen__;